...
import { Home, ChevronRight, Code, Cpu, ShieldAlert, Sparkles, ArrowRight, Kanban } from "lucide-react"
  ...
  const features = [
    {
      ...
      icon: <Cpu className="size-6 text-anthem-blue" />,
    },
    {
    ...
    },
    {
      ...
      icon: <Code className="size-6 text-anthem-blue" />,
    },
  ]
  ...
  return (
    <div className="flex min-h-screen flex-col overflow-hidden bg-background">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden bg-[radial-gradient(circle_at_20%_20%,rgba(1,122,202,0.08),transparent_50%)]">
        <div className="absolute inset-0 opacity-10 pointer-events-none bg-[url('/Anthem%20Assests/images_ban-costom-software.jpg')] bg-cover bg-center" />
        ...
        <div className="container px-4 md:px-6 relative z-10 mx-auto">
          ...
          <div className="flex items-center gap-2 text-xs md:text-sm text-muted-foreground mb-6">
            ...
            <ChevronRight className="size-3.5 text-muted-foreground/50" />
            <span className="text-anthem-blue font-medium">Custom Software Development</span>
          </div>
              ...
              <Card className="border border-border/40 bg-card/65 backdrop-blur-md shadow-lg overflow-hidden h-full">
                ...
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold text-foreground">Next-Gen Engineering</h2>
                  </div>
      ...
      <section className="py-16 bg-muted/30 border-t border-border/30">
        <div className="container px-4 md:px-6 mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Build High-Performance Systems</h2>
          <p className="text-muted-foreground max-w-xl mx-auto mb-6">
            Get in touch with our engineering team to design, map, and deploy a robust custom software suite for your organization.
          </p>
          <div className="flex justify-center gap-4">
            <Link href="/contact">
              <Button variant="anthem" className="shadow-lg px-8 py-5 rounded-full">
                Schedule Technical Consultation <ArrowRight className="ml-2 size-4" />
              </Button>
            </Link>
          </div>
        </div>
